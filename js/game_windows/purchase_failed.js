let PurchaseFailed = new Phaser.Class({
    ...
    init(params) {
        let temp = {'scene_id': 'game_windows', 'item_id': 'purchase_failed', 'phrase_id': '1', 'values': [], 'base_size': 42};
        ...
        res = game_data['utils'].generate_string({'scene_id': 'game_windows', 'item_id': 'purchase_failed', 'phrase_id': '3', 'values': [], 'base_size': 35});
        ...
        let icon = new Phaser.GameObjects.Image(this.scene, 0, 0, 'common1', 'icon_failed');
        icon.setOrigin(0.5);
        this.add(icon);
